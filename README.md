...
Note: Only **weekly_report_1** is available as a viewable GoogleSheet version and full version after download in Excel. Other reports are presented as screenshots due to differences in pivot table behavior and layout between Excel and Google Sheets, which may affect data structure in dashboards and readability.
